...
class TestDynamodbApi(unittest.TestCase):
    ...
    def test_remove_duplicate_attributes(self):
        ...
        self.assertEqual(
            dynamodb_api.remove_duplicated_attributes(
                new_attributes={"address": "Jeff Bezos Candy land road", "age": "32"},
        ...
        self.assertEqual(
            dynamodb_api.push_update(
                ...
                expression_attribute_values={
                    ":ad": {"S": "Rochet trust drive"},
                    ":ag": {"S": "35"},
                },
            )["Attributes"],
            {"address": {"S": "Rochet trust drive"}, "age": {"S": "35"}},
        )
    ...
    def test_delete_item(self):
        ...
        self.assertTrue(
            dynamodb_api.remove_item(
                key={"CustomerId": {"S": "1482328721"}, "name": {"S": "John Joseph"}}
            )
        )
