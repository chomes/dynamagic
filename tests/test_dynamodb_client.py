...
class TestDynamoDBClient(unittest.TestCase):
    ...
    def test_confirm_item_updated(self):
        dynamodb_client: DynamodbClient = DynamodbClient(aws_region="eu-west-2",
        dynamodb_table="test_table")
        self.assertTrue(dynamodb_client.confirm_item_updated(update_response={
            "Attributes": {"age": {"S": "32"},
                     "car": {"S": "Black Skoda"}
                     }
                     }, confirmed_new_attributes={
                         "age": "32",
                         "car": "Black Skoda"
                     }
                     )
    ...
    def test_confirm_item_raising_exception(self):
        ...
        with self.assertRaises(ValidationFailedAttributesUpdateError):
            dynamodb_client.confirm_item_updated(update_response={},
             confirmed_new_attributes={
                         "age": "32",
                         "car": "Black Skoda"
                     }
    ...
    def test_update_item(self):
        ...
        self.assertEqual(dynamodb_client.update_item(
            dynamodb_attributes={
                "CustomerId": "1482328791",
                "age": "45",
                "car": "Blue BMW"
    ...
    def test_failing_update_item(self):
        dynamodb_client: DynamodbClient = DynamodbClient(aws_region="eu-west-2",
        dynamodb_table="test_table")
        self.assertEqual(dynamodb_client.update_item(dynamodb_attributes={
            "Test_key": 4828201
            }),
            {"status_code": 400,
    ...
    def test_fetching_item(self):
        ...
        self.assertEqual(dynamodb_client.fetch_item(key={
            "CustomerId": "1482328791"
        }), {
            "status_code": 200,
            "message": {
    ...
    def test_fetch_items(self):
        ...
        self.assertEqual(dynamodb_client.fetch_items(), {
    ...
    def test_deleting_item(self):
        ...
        self.assertEqual(dynamodb_client.delete_item(key={
            "CustomerId": "1482328791"
            }),
            {
                "status_code": 200,
